...
<div class="pre-loader">
    <div class="pre-loader-box">
        <div class="loader-logo"><img src="assets/images/deskapp-logo.svg" alt=""></div>
...
<div class="header">
    ...
    <div class="header-right">
        ...
        <div class="github-link">
            <a href="https://github.com/dropways/deskapp" target="_blank"><img src="assets/images/github.svg" alt=""></a>
        </div>
    </div>
</div>
...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="index.html">
            ...
            <img src="assets/images/deskapp-logo-white.svg" alt="" class="light-logo">
        </a>
    ...
    <div class="pd-ltr-20">
        ...
        <div class="card-box mb-30">
            ...
            <table class="data-table table nowrap">
                ...
                <tr>
                    <td class="table-plus">
                        <img src="assets/images/product-1.jpg" width="70" height="70" alt="">
                    </td>
                    <td>
                ...
                <tr>
                    <td class="table-plus">
                        <img src="assets/images/product-2.jpg" width="70" height="70" alt="">
                    </td>
                    <td>
                ...
                <tr>
                    <td class="table-plus">
                        <img src="assets/images/product-3.jpg" width="70" height="70" alt="">
                    </td>
                    <td>
                ...
                <tr>
                    <td class="table-plus">
                        <img src="assets/images/product-4.jpg" width="70" height="70" alt="">
                    </td>
                    <td>
                ...
                <tr>
                    <td class="table-plus">
                        <img src="assets/images/product-5.jpg" width="70" height="70" alt="">
                    </td>
                    <td>
